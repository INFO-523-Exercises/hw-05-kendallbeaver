...
# Create variable to store numeric column names:

numeric_dataset <- combined_dataset %>%
  select(-months, -state, -stressor)
numeric_dataset
...
library(gplots)
heatmap(cor(combined_dataset), col = colorRampPalette(c("blue", "white", "red"))(20))
```
